...
| 984   | [zato](https://github.com/zatosource/zato)                | BE    | python    |             | ESB, SOA, API and Cloud Integrations in Python.                                                                                            |
...
| [集成自动化 Make](http://make.com/)                           |       |              |        | streamline our operations via automation sequences.                     |
...
- [WorkOs](https://workos.com/) Start selling to enterprise customers with just a few lines of code. Implement features like single sign-on in minutes instead of months.
...
### CMS
- 22.9k [md2ppt](https://github.com/slidevjs/slidev)
- 4.8k  [作文生成器](https://github.com/EssayKillerBrain/EssayKiller_V2)
- 2.9k  [笔记服务](https://github.com/archivy/archivy/)
- 1.2k  [Swagger导出md](https://www.docs4dev.com/tools/zh/swagger2markup/)
...
- [去背景](https://www.remove.bg/)
- [去背景](http://magiceraser.io/)
- [本地扣图](https://bgsub.cn/)
- [图片着色](https://palette.fm/)
- [图片着色](https://colorize.cc/)
- [头像生成](https://multiavatar.com/)
- [图片编辑](https://www.nvidia.com/en-gb/studio/canvas/)
- [照片2线画](https://javier.xyz/pintr/)
- [印章](https://www.makepic.net/tool/signet.html)
- [Thing Translator](http://thing-translator.appspot.com) Identify objects from photos with Thing Translator
- [Let’s Enhance](http://letsenhance.io/) resize it without losing quality
- [Ai绘画咒语](https://prompt.noonshot.com/midjourney)
- 46.1k [face\_recognition](https://github.com/ageitgey/face_recognition) 简单易用的 Python 人脸识别库。
- 11.4k [图片翻译](https://github.com/junyanz/CycleGAN)
- 9.2k [图片翻译](https://github.com/phillipi/pix2pix)
- 9.2k [thumbor](https://github.com/thumbor/thumbor) 一个小型图像服务，具有剪裁，尺寸重设和翻转功能。
- 6.7k [pywal](https://github.com/dylanaraps/pywal) 由图像生成配色方案的工具。
- 5.1k [人脸修改](https://github.com/yunjey/StarGAN)
- 3.8k [照片三角化](https://github.com/RH12503/Triangula) Generate high-quality triangulated and polygonal art from images.
- 3.3k [人脸修改](https://github.com/run-youngjoo/SC-FEGAN)
- 1.5k [去背景](https://github.com/nadermx/backgroundremover)
- 1.3k [机器读图](https://github.com/alibaba/AliceMind)
- 399 [python-barcode](https://github.com/WhyNotHugo/python-barcode) 不借助其他库在 Python 程序中生成条形码。

## Audio and Video Tools
- [MD2Video](http://mdvideo.gshll.com/)
- [实时字幕](https://webcaptioner.com/)
...
- 8.1k [视频生成](https://github.com/NVIDIA/vid2vid)
- 1.5k [生成字幕切分视频 autocut](https://github.com/mli/autocut)
- 236 [生成时间轴](https://github.com/baxtree/subaligner)

## 3D and XR Tools
- [3D场景](https://www.muse.place/)
- [AR相册](https://awesomealbum.com/photobook)
...
- 3.3k [RenPy](https://www.renpy.org/) 一个视觉小说（visual novel）引擎。
...
- [搞笑工具](https://lab.magiconch.com/)
- [在线造塔](https://oskarstalberg.com/Townscaper)
- [Temp-mail]() temporary email and inbox
- [远程工作网](https://eleduck.com/)
